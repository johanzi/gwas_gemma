...
if [ -e ${current_path}/output/${prefix_gwas}.assoc.txt ]; then
	...
	if [ $covariate_file ]; then	
		echo -e "\ngemma -bfile ${path_prefix_vcf} -k ${current_path}/output/${prefix_vcf}.cXX.txt -lmm 4 -maf 0.05 -o ${prefix_gwas} -c $covariate_file"
		gemma -bfile ${path_prefix_vcf} -k ${current_path}/output/${prefix_vcf}.cXX.txt -lmm 4 -maf 0.05 -o ${prefix_gwas} -c $covariate_file
	else
		echo -e "\ngemma -bfile ${path_prefix_vcf} -k ${current_path}/output/${prefix_vcf}.cXX.txt -lmm 4 -maf 0.05 -o ${prefix_gwas}"
		gemma -bfile ${path_prefix_vcf} -k ${current_path}/output/${prefix_vcf}.cXX.txt -lmm 4 -maf 0.05 -o ${prefix_gwas}
	fi
fi
...
# gemma -bfile ${path_prefix_vcf} -k ${current_path}/output/${prefix}.cXX.txt -lmm 4 -n 1 2 3 -o ${prefix}
